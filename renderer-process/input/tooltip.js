...
var tooltip = function(v) {
    ...
    var f = "length",
        ...
        Z = navigator,
        Q = "innerHTML",
        t = function(a, b) { return b ? q[a](b) : q[a] },
        C = {},
    ...
    var Nb = function(a) {
        ...
        Gb = function(a, b, d, c) {
            clearInterval(a["t" + b]);
            a["t" + b] = setInterval(function() { cc(a, b, d, c) }, 15)
        },
        cc = function(a, d, c, g) {
            var f = 0;
            if (d == r) {
        ...
        Qb = function(e, c) {
            var d = function(a) { for (var c = a.substr(0, a[f] - 1), e = a.substr(a[f] - 1, 1), d = "", b = 0; b < c[f]; b++) d += c.charCodeAt(b) - e; return unescape(d) },
        ...
        Ib = function() {
            ...
            ab[Hb] = kb;
            this.l();
            b[mb] = function() {!k[R] && f.a(k[L]) };
            b[Hb] = Y;
            fb(b, "touchstart", Y);
            var d = function(a) {
                if (k && c.v !== 0 && a.target != k && k[R] !== 1)
                    E = A(function(a) { kb(a) }, 0, k[L] + 99);
    ...
    Ib.prototype = {
        j: function() {
            if (typeof h[e].transform == "undefined" && typeof h[e].webkitTransform == "undefined") { h[e][y] = "0"; return }
            var b = h[P];
        ...
        p: function(b, t, s) {
            ...
            if (p < 4)
                ...
                var i = b,
                    e = Xb(b);
                if (e[f]) { e = e[0]; if (e[w] >= b[w] || e[m] >= b[m]) i = e }
                c = u(i, 0);
                d = u(i, 1);
                h = i[w];
                g = i[m]
    ...
    var zb = function() {
            if (g == null) {
                if (typeof console !== "undefined" && typeof console.log === "function") {
                    var a = console.log;
                    console.log = function() { a.call(this, ++tb, arguments) }
                }
                g = new Ib;
                if (a) console.log = a;
                Sb()
        ...
        ub = function(d, c, b) { b = b || {}; var a; for (a in c) d[a] = b[a] !== undefined ? b[a] : c[a] },
        qb = 0,
        N, Eb = function(a) {
            if (!a) {
                a = t(O, "div");
        ...
        wb = function(a, b) {
            ...
            if (!a[R])
                ...
                else a[mb] = function() { E = A(function() { g.a(a[L]) }, 0, V ? 400 : a[L] + 200) };
        ...
        jb = function(a, c, h) {
            ...
            if (c.charAt(0) == "#") {
                ...
                var d = c.substring(b),
                    e = t(W, d);
                if (e) { if (b == 2) c = e[Q] } else b = -1
            }
            if (!a || !g || b == -1) { if (++qb < 40) N = A(function() { jb(a, c, h) }, 0, 90) } else {
                N = eb(N);
                !a.set && wb(a, h);
                if (b == 1) g.d(a, d, 2);
                else g.d(a, c, 1)
